...
namespace simple_pmc_mover
{
    internal class De_nest_test : Movement
    {
        ...
        public WaitUntilTriggerParams lineDenesterGrips(int[] lineDenesterIDs, int line_number,  WaitUntilTriggerParams wait_params, ushort command_label, bool shifted, bool second_run)
        {
            ...
            _xbotCommand.LinearMotionSI(command_label, lineDenesterIDs[1], POSITIONMODE.RELATIVE, LINEARPATHTYPE.YTHENX, 0, -0.040, 0, 0.1, 0.01);
        ...
        public WaitUntilTriggerParams lineDenesterMovesToCarrier(int[] lineDenesterIDs, WaitUntilTriggerParams wait_params, ushort command_label)
        {
            ...
            //rotates
            _xbotCommand.ArcMotionMetersRadians(0, lineDenesterIDs[1], ARCMODE.CENTERANGLE, ARCTYPE.MINORARC, ARCDIRECTION.COUNTERCLOCKWISE, POSITIONMODE.ABSOLUTE, 0.445, 0.360, 0, 0.05, 0.1, 0.179, 1.65);
            _xbotCommand.ArcMotionMetersRadians(111, lineDenesterIDs[1], ARCMODE.CENTERANGLE, ARCTYPE.MINORARC, ARCDIRECTION.CLOCKWISE, POSITIONMODE.ABSOLUTE, 0.445, 0.360, 0, 0.05, 0.1, 0.179, 1.65 - 1.570796);
        ...
        public WaitUntilTriggerParams lowerSyringesIntoCarrier(int[] lineDenesterIDs, WaitUntilTriggerParams wait_params, ushort command_label)
        {
            ...
            _xbotCommand.LinearMotionSI(99, lineDenesterIDs[1], POSITIONMODE.RELATIVE, LINEARPATHTYPE.YTHENX, -0.035, 0, 0, 0.01, 0.05);
            ...
            _xbotCommand.LinearMotionSI(888, lineDenesterIDs[0], POSITIONMODE.RELATIVE, LINEARPATHTYPE.YTHENX, -0.005, 0, 0, 0.01, 0.05);
        ...
        public WaitUntilTriggerParams de_nester_back_to_nest(int[] lineDenesterIDs, WaitUntilTriggerParams wait_params, ushort command_label)
        {
            ...
            _xbotCommand.ArcMotionMetersRadians(0, lineDenesterIDs[1], ARCMODE.CENTERANGLE, ARCTYPE.MINORARC, ARCDIRECTION.CLOCKWISE, POSITIONMODE.ABSOLUTE, 0.445, 0.360, 0, 0.05, 0.1, 0.179, 1.65);
            _xbotCommand.ArcMotionMetersRadians(command_label, lineDenesterIDs[1], ARCMODE.CENTERANGLE, ARCTYPE.MINORARC, ARCDIRECTION.COUNTERCLOCKWISE, POSITIONMODE.ABSOLUTE, 0.445, 0.360, 0, 0.05, 0.1, 0.179, 1.65 - 1.570796);
